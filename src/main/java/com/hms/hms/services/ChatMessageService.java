...
import com.hms.hms.repositories.ChatMessageRepository;
...
public class ChatMessageService {
    ...
    public List<MessageModel> findChatMessages(String senderId, String recipientId) {
    ...
    public void updateStatuses(String senderId, String recipientId, MessageStatus status) {
        ...
        mongoOperations.updateMulti(query, update, MessageModel.class);
    }
